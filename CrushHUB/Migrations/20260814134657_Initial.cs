        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OsName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    Gpu = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    MemoryMb = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    GameUserId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScreenshotPath = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "161B548E-0A90-43E0-A76E-0F34C60955B0", "521d70ab-4374-4e03-b939-535e4086198e", "admin", "ADMIN" },
                    { "2F5F5C1E-3A65-4F0C-9E5F-9F2A0B6C4D11", "8c1de6f0-5f2b-4b8a-9a4c-1d0f6b7e2a33", "member", "MEMBER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "4B00D67B-169D-459D-8BE0-5A1F9575F247", 0, null, "f46a6c1e-c201-4b8c-bca7-e39627f4e8ad", "Администратор", "admin@admin.com", true, false, null, "ADMIN@ADMIN.COM", "ADMIN", "AQAAAAIAAYagAAAAEH9/P9sjnqQYmtdLt4WYqMyiUKm+/CJ1l0+xpKP+nZQkWEEA13l064nLv25vllnFXQ==", null, true, "", false, "admin" });
